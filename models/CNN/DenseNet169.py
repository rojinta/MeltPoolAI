...
train_loss = [0.5599, 0.4180, 0.3654, 0.3399, 0.3352, 0.3165, 0.2945, 0.3098, 0.3270, 0.3076]

# Training accuracy per epoch
train_acc = [76.38, 85.15, 84.50, 87.18, 86.12, 87.18, 87.99, 86.61, 86.53, 86.69]

# Validation accuracy per epoch
val_acc = [60.06, 81.82, 84.09, 80.84, 74.35, 75.32, 75.97, 72.73, 77.92, 78.90]
...
plt.savefig('densenet169_training_results.pdf') 

# Save the entire figure as a PNG file with higher resolution
plt.savefig('densenet169_training_results.png', dpi=300)
