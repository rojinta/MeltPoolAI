...
# Define the ViT Base model setup function
def get_vit_base():
...
def main():
    ...
    # Log file setup
    log_file_path = os.path.join(RESULTS_DIR, "logs", "vit_base_training.log")
    ...
    plot_path = os.path.join(RESULTS_DIR, "plots", "vit_base_best_metrics.png")
