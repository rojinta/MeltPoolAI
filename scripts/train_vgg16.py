...
# Define the VGG16 model setup function
def get_vgg16():
...
def main():
    ...
    # Log file setup
    log_file_path = os.path.join(RESULTS_DIR, "logs", "vgg16_training.log")
    ...
    plot_path = os.path.join(RESULTS_DIR, "plots", "vgg16_best_metrics.png")
