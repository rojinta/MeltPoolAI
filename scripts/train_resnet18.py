...
# Define the ResNet18 model setup function
def get_resnet18():
...
def main():
    ...
    # Log file setup
    log_file_path = os.path.join(RESULTS_DIR, "logs", "resnet18_training.log")
    ...
    plot_path = os.path.join(RESULTS_DIR, "plots", "resnet18_best_metrics.png")
